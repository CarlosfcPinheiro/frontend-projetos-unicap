            ...
            <main>
                ...
                <section className="w-full h-auto flex justify-center">
                    <div className="content__container w-[60%] h-auto pt-10 pb-10">
                        <h1 className={styles.text_gradient}>
                            # Hello, world!
                        </h1>
                        <div className="p__container mt-3 flex flex-col gap-4 text-[]">
                            <p className={styles.secondary_text}>
                                Meu nome é Carlos Pinheiro, e sou um
                                desenvolvedor Full-Stack. Estou sempre em busca
                                de me conectar com as pessoas e de aprender
                                novas tecnologias, Além disso, também tenho
                                muito apreço pela ciência ligada a tópicos
                                computacionais.
                            </p>
                            <p className={styles.secondary_text}>
                                Me mantenho presente em comunidades de
                                tecnologia, e um gosto especial por open-source.
                                Em momentos de descanso gosto de fazer artes
                                digitais, uma boa leitura e estudar música.
                            </p>
                        </div>
                    </div>
                </section>
